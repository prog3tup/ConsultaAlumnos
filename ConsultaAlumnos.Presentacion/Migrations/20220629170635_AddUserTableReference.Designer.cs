...
namespace ConsultaAlumnos.API.Migrations
{
    ...
    [Migration("20220629170635_AddUserTableReference")]
    partial class AddUserTableReference
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ConsultaAlumnos.API.Entities.Question", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("ConsultaAlumnos.API.Entities.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("ConsultaAlumnos.API.Entities.Professor", b =>
                {
                    b.HasBaseType("ConsultaAlumnos.API.Entities.User");
            ...
            modelBuilder.Entity("ConsultaAlumnos.API.Entities.Student", b =>
                {
                    b.HasBaseType("ConsultaAlumnos.API.Entities.User");
            ...
            modelBuilder.Entity("ConsultaAlumnos.API.Entities.Question", b =>
                {
                    b.HasOne("ConsultaAlumnos.API.Entities.Student", "Student")
                        .WithMany("Questions")
                        .HasForeignKey("CreatorStudentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ConsultaAlumnos.API.Entities.Professor", "AssignedProfessor")
                        .WithMany("Questions")
                        .HasForeignKey("ProfessorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ConsultaAlumnos.API.Entities.Subject", "Subject")
                        .WithMany("Questions")
            ...
            modelBuilder.Entity("ConsultaAlumnos.API.Entities.Response", b =>
                {
                    b.HasOne("ConsultaAlumnos.API.Entities.User", "Creator")
                        .WithMany()
                        .HasForeignKey("CreatorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ConsultaAlumnos.API.Entities.Question", "Question")
                        .WithMany("Responses")
            ...
            modelBuilder.Entity("ProfessorSubject", b =>
                {
                    b.HasOne("ConsultaAlumnos.API.Entities.Professor", null)
                        .WithMany()
                        .HasForeignKey("ProfessorsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ConsultaAlumnos.API.Entities.Subject", null)
                        .WithMany()
            ...
            modelBuilder.Entity("StudentSubject", b =>
                {
                    b.HasOne("ConsultaAlumnos.API.Entities.Student", null)
                        .WithMany()
